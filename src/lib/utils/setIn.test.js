...
describe('setIn', () => {
  describe('invalid input', () => {
    it('should throw an error when name is undefined', () => {
      expect(() => setIn({}, undefined, 'some value')).toThrow(
        /setIn\(\) with undefined name/
      )
    })
    it('should throw an error when name is null', () => {
      expect(() => setIn({}, null, 'some value')).toThrow(/setIn\(\) with null name/)
    })
    it('should throw an error when trying to set a non-numeric name into an array', () => {
      expect(() => setIn([], 'foo', 'bar')).toThrow(/non-numeric property on an array/)
    })
    it('should throw an error when trying to set a numeric name into an object', () => {
      expect(() => setIn({}, '42', 'bar')).toThrow(/numeric property on an object/)
    })
  })
  ...
  it('should delete structure when setting undefined on non-existing name', () => {
    const a = {}
    const b = {}
    const input = { a, b, dog: {} }
  ...
  it('should not delete structure when setting undefined to a nonexistent name and other keys exist', () => {
    const a = {}
    const input = { a }
    const output = setIn(input, 'b', undefined)
    expect(input).not.toBe(output)
  ...
  it('should not delete array structure when setting undefined to one value of many', () => {
    const a = {}
    const b = {}
  ...
  it('should delete array structure when setting undefined to a nonexistent name and other keys exist', () => {
    const a = {}
    const b = {}
    const c = {}
  ...
  it('should not create an array structure when setting undefined', () => {
    ...
    const b = {}
    const input = { a, b }
    const output = setIn(input, 'dog[0].mouse', undefined)
    expect(input).not.toBe(output)
    expect(output.a).toBe(a)
    expect(output.b).toBe(b)
    expect(output.dog).toBeUndefined()
